...
public class SoundOfEmptyBeach extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_of_empty_beach);
        setTitle("Empty Beach");
        mediaPlayer = MediaPlayer.create(this, R.raw.empty_beach);
