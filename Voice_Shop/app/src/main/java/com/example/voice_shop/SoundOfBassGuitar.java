...
public class SoundOfBassGuitar extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_of_bass_guitar);
        setTitle("Bass Guitar");
        mediaPlayer = MediaPlayer.create(this, R.raw.bass_guitar);
