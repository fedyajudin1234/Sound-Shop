...
public class SoundOfSeagullsAndSurf extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_of_seagulls_and_surf);
        setTitle("Seagulls And Surf");
        mediaPlayer = MediaPlayer.create(this, R.raw.seagulls_and_surf);
