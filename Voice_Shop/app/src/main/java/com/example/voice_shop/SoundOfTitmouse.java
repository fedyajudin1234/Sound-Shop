...
public class SoundOfTitmouse extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_of_titmouse);
        setTitle("Titmouse");
        mediaPlayer = MediaPlayer.create(this, R.raw.titmouse);
