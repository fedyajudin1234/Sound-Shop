...
public class SoundOfFireworks extends AppCompatActivity implements View.OnClickListener{
    MediaPlayer mediaPlayer;
    Button buttonPlay;
    Button buttonBackToHolidayMenu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_of_fireworks);
        setTitle("Fireworks");
        mediaPlayer = MediaPlayer.create(this, R.raw.fireworks);
        buttonPlay = findViewById(R.id.buttonPlay);
        buttonPlay.setOnClickListener(this);
        buttonBackToHolidayMenu = findViewById(R.id.buttonBackToMachinesMenu);
        buttonBackToHolidayMenu.setOnClickListener(this);
