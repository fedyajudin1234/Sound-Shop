...
public class SoundOfHail extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_of_hail);
        setTitle("Hail");
        mediaPlayer = MediaPlayer.create(this, R.raw.hail);
