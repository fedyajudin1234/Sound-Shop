...
public class SoundOfCock extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_of_cock);
        setTitle("Cock");
        mediaPlayer = MediaPlayer.create(this, R.raw.cock);
