...
public class SoundOfAtlanticOcean extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_of_atlantic_ocean);
        setTitle("Atlantic Ocean");
        mediaPlayer = MediaPlayer.create(this, R.raw.atlantic_ocean);
