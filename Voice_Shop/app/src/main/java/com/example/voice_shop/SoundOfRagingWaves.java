...
public class SoundOfRagingWaves extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_of_raging_waves);
        setTitle("Raging Waves");
        mediaPlayer = MediaPlayer.create(this, R.raw.raging_waves);
