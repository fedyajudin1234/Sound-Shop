...
public class SoundOfOceanDepth extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_of_ocean_depth);
        setTitle("Ocean Depth");
        mediaPlayer = MediaPlayer.create(this, R.raw.ocean_depth);
