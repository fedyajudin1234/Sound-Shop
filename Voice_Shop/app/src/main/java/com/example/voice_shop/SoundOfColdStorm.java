...
public class SoundOfColdStorm extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_of_cold_storm);
        setTitle("Cold Storm");
        mediaPlayer = MediaPlayer.create(this, R.raw.cold_storm);
