...
public class SoundOfRustleOfLeaves extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_of_rustle_of_leaves);
        setTitle("Rustle Of Leaves");
        mediaPlayer = MediaPlayer.create(this, R.raw.rustle_of_leaves);
